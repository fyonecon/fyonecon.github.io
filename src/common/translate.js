...
const lang_dict = {
    ...
    mp_notice_txt: {
        zh: '<p>◉ 内容仅供教育学习。</p>' +
            '<p>◉ 谨防网络赌博诈骗。</p>' +
            '<p>◉ 推荐“联通、电信”等网络。</p>' +
            '<p>◉ 白名单浏览器：<i class="select-text"> <a class="a-url font-blue" href="https://apps.apple.com/us/app/adblock-for-safari/id1402042596">Safari（可屏蔽广告）</a>、<a class="a-url font-blue" href="https://www.microsoft.com/en-us/edge/download">Edge（可屏蔽广告）</a>、<a class="a-url font-blue" href="https://www.downkuai.com/android/157308.html">三星浏览器（可屏蔽广告）</a>、<a class="a-url font-blue" href="https://www.firefox.com/zh-CN/download/">火狐</a> </i>。</p>',
        en: '<p>◉ The content is for educational purposes only.</p>' +
            ...
            '<p>◉ Whitelist browser: <i class="select-text"> <a class="a-url font-blue" href="https://apps.apple.com/us/app/adblock-for-safari/id1402042596">Safari(Ad-blocking)</a>, <a class="a-url font-blue" href="https://www.microsoft.com/en-us/edge/download">Edge(Ad-blocking)</a>, <a class="a-url font-blue" href="https://www.downkuai.com/android/157308.html">SamsungBrowser(Ad-blocking)</a>, <a class="a-url font-blue" href="https://www.firefox.com/zh-CN/download/">Firefox</a> </i>.</p>',
    },
    mp_so: {
        zh: "查找",
        en: "Find",
