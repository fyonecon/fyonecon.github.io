...
const lang_dict = {
    ...
    mp_notice_txt: {
        zh: '<p>◉ 内容仅供教育学习。谨防网络赌博诈骗。</p>' +
            ...
            '<a class="a-url font-blue" href="https://www.microsoft.com/en-us/edge/download">Edge（可屏蔽广告）</a>、' +
            // '<a class="a-url font-blue hide" href="https://www.downkuai.com/android/109376.html">火狐浏览器（国际服可屏蔽广告）</a>、' +
            '</br>电脑 Win/Mac：' +
            '<a class="a-url font-blue" href="https://www.firefox.com/zh-CN/download/">火狐浏览器（国际服可屏蔽广告）</a>。' +
            '</span></i></p>',
        en: '<p>◉ The content is for educational purposes only. Beware of online gambling fraud.</p>' +
            ...
            '<a class="a-url font-blue" href="https://www.microsoft.com/en-us/edge/download">Edge (Ad-blocking)</a>, ' +
            // '<a class="a-url font-blue hide" href="https://www.downkuai.com/android/109376.html">Firefox (International server can block ads)</a>, ' +
            '</br>Desktop Win/Mac: ' +
